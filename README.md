...
- **학생**: 구조화된 방식으로 익명 피드백 작성 (1회용 토큰 링크로 접근)
...
- 강의자료 분석: PDF/PPT/TXT 업로드 → AI 핵심 요약, 난이도, 용어 밀도, 예시 충분도, 개선 제안
