...
async function main() {
  ...
  const kimDetailedFeedbacks2 = [
    ...
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "강의자료 1주차 ERD→테이블 변환규칙 표가 ER 다이어그램을 실제 스키마로 바꾸는 과정을 한눈에 보여줘서 도움됐습니다." },
    ...
    { speed: "moderate", comprehension: "medium", communication: 3,
      ...
      freeText: "수업 자료가 수업 당일에 올라와서 예습을 못 했습니다. 전날 저녁이라도 올려주시면 기본 개념 보고 올 수 있어요." },
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "강의자료에 학생·강좌·수강 테이블 DDL 전체 코드가 있어서 집에서 그대로 따라 실행해볼 수 있었습니다." },
    { speed: "fast", comprehension: "medium", communication: 3,
    ...
    { speed: "moderate", comprehension: "high", communication: 4,
      ...
      freeText: "수업 전날 강의자료가 올라와 있어서 DDL 문법 훑어보고 왔는데 실습 따라가기 훨씬 편했습니다. 앞으로도 전날 저녁에 올려주세요." },
    ...
    { speed: "moderate", comprehension: "high", communication: 4,
      ...
      freeText: "강의자료 JOIN 유형 비교 표(INNER/LEFT/RIGHT/SELF)가 각 쿼리 결과를 나란히 보여줘서 헷갈릴 때마다 다시 참고하기 좋습니다." },
    { speed: "moderate", comprehension: "medium", communication: 3,
    ...
    { speed: "moderate", comprehension: "high", communication: 4,
      ...
      freeText: "강의자료 SELF JOIN 예시 쿼리가 별칭 s1, s2 붙여서 명확하게 정리돼 있어서 집에서 다시 따라 해봤습니다." },
    { speed: "fast", comprehension: "medium", communication: 3,
    ...
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "강의자료 격리수준 4단계×동시성 문제 3종 대응 표가 나중에 시험 공부할 때도 바로 쓸 수 있겠다 싶어서 저장해뒀습니다." },
    { speed: "moderate", comprehension: "medium", communication: 3,
      comment: null, filteredComment: null, commentCategory: null, commentFilterReason: null,
      freeText: "오늘 GROUP BY 실습 쿼리 파일을 포털에 올려주시면 집에서 다시 연습하기 좋겠습니다." },
    ...
    { speed: "moderate", comprehension: "high", communication: 5,
      ...
      freeText: "실행 순서 표가 강의자료에 있어서 집에서도 다시 보기 좋았습니다. 앞으로도 이런 요약 표를 계속 넣어주시면 좋겠어요." },
    { speed: "fast", comprehension: "medium", communication: 3,
    ...
    { speed: "moderate", comprehension: "high", communication: 4,
      ...
      freeText: "COALESCE 함수 설명이 짧게 넘어갔는데, 실제 NULL 대체 사례를 한 가지만 더 보여주시면 완벽할 것 같습니다." },
    { speed: "moderate", comprehension: "medium", communication: 3,
    ...
    { speed: "fast", comprehension: "low", communication: 2,
      ...
      freeText: "강의자료 WHERE 조건 연산자 표는 잘 정리되어 있었는데, 수업에서 그 표를 조금 더 천천히 설명해주시면 좋겠습니다." },
    { speed: "fast", comprehension: "low", communication: 2,
      ...
      freeText: "강의자료 실습 문제 자체는 잘 구성되어 있는데, 심화(Q5·Q6) 문제에 접근법 힌트 한 줄씩만 추가해주시면 훨씬 좋겠습니다." },
    { speed: "moderate", comprehension: "high", communication: 4,
    ...
    { speed: "moderate", comprehension: "medium", communication: 3,
      comment: null, filteredComment: null, commentCategory: null, commentFilterReason: null,
      freeText: "오늘 JOIN 실습 예제 데이터를 이메일이나 포털로 공유해주시면 집에서도 따라 해볼 수 있을 것 같아요." },
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "강의자료 PDF가 수업 시작 전에 올라와 있어서 미리 한 번 읽고 올 수 있었는데, 이해 속도가 훨씬 빨랐습니다. 앞으로도 전날까지 올려주세요." },
    ...
    { speed: "moderate", comprehension: "high", communication: 5,
      ...
      freeText: "강의자료에 뷰 vs 인라인 뷰 선택 기준 표가 있어서 헷갈리던 부분이 정리됐습니다. 이런 비교 표를 앞으로도 계속 넣어주세요." },
    { speed: "fast", comprehension: "medium", communication: 3,
    ...
    { speed: "fast", comprehension: "low", communication: 2,
      ...
      freeText: "강의자료 디버깅 명령어 표(SHOW ERRORS/WARNINGS 등)가 실습할 때 바로 옆에 있어서 유용했습니다." },
    { speed: "moderate", comprehension: "medium", communication: 3,
    ...
    { speed: "moderate", comprehension: "medium", communication: 3,
      ...
      freeText: "강의자료 트랜잭션+프로시저 조합 코드가 실무에서 바로 쓸 수 있는 형태라 따로 저장해뒀습니다." },
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "강의자료 PDF 자주 하는 실수 Top 5가 이번 주 실습할 때 바로 참고가 됐습니다. 다음 주도 이 형식으로 넣어주세요." },
    { speed: "moderate", comprehension: "medium", communication: 3,
      comment: null, filteredComment: null, commentCategory: null, commentFilterReason: null,
      freeText: "뷰 삭제(DROP VIEW IF EXISTS) 구문을 강의 중에 빠르게 지나쳤는데, 강의자료에 있어서 나중에 확인했습니다. 실습 시 자주 쓰는 관리 명령어들을 한 번씩 직접 실행해보는 시간이 있으면 좋겠어요." },
    ...
    { speed: "moderate", comprehension: "high", communication: 4,
      ...
      freeText: "강의자료 트리거 타이밍 × 이벤트 조합 표가 실습할 때 옆에 두고 참고하기 딱 좋았습니다." },
    { speed: "moderate", comprehension: "medium", communication: 3,
    ...
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "강의자료 인덱스 유무 성능 비교 표가 실측치 기반이라 신뢰가 갔습니다. EXPLAIN ANALYZE 결과도 다음에 같이 보여주시면 좋겠어요." },
    { speed: "fast", comprehension: "medium", communication: 3,
    ...
    { speed: "moderate", comprehension: "high", communication: 4,
      ...
      freeText: "강의자료 인덱스 설계 원칙 bullet이 간결하게 정리돼 있어서 그대로 복사해서 노션에 저장했습니다." },
    { speed: "moderate", comprehension: "medium", communication: 3,
    ...
    { speed: "moderate", comprehension: "medium", communication: 3,
      comment: null, filteredComment: null, commentCategory: null, commentFilterReason: null,
      freeText: "EXPLAIN 실습 SQL 파일을 포털에 올려주시면 집에서 다시 해보기 좋을 것 같아요. 수업 시간에 실행해본 쿼리들을 그대로 파일로 공유해주시면 됩니다." },
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "강의자료 자주 하는 실수 Top 5에서 BEFORE INSERT에 OLD 참조 항목이 실습 직후에 딱 맞아서 바로 고쳤습니다. 이 형식 계속 유지해주세요." },
    ...
    { speed: "moderate", comprehension: "medium", communication: 3,
      ...
      freeText: "강의자료 SQL vs 집계 파이프라인 대응 표가 정말 유용했습니다. 캡처해서 노션에 저장해뒀어요." },
    { speed: "fast", comprehension: "medium", communication: 3,
    ...
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "Compass Explain Plan 탭이 RDBMS의 EXPLAIN처럼 쿼리 실행 계획을 보여준다는 것도 알게 됐습니다. 다음에 이 부분도 같이 다뤄주시면 좋겠어요." },
    { speed: "fast", comprehension: "low", communication: 2,
    ...
    { speed: "moderate", comprehension: "medium", communication: 3,
      ...
      freeText: "강의자료 학기 마무리 회고 섹션이 전체 흐름을 한눈에 정리해줘서 기말 준비에 도움이 됩니다." },
    { speed: "moderate", comprehension: "medium", communication: 3,
      comment: null, filteredComment: null, commentCategory: null, commentFilterReason: null,
      freeText: "NoSQL 실습 데이터를 강의 포털에 JSON 파일로 올려주시면 집에서 추가 연습하기 좋겠어요." },
    { speed: "slow", comprehension: "high", communication: 5,
      ...
      freeText: "6주 내내 강의자료 PDF를 수업 전날 올려주셔서 예습하고 올 수 있었습니다. 다음 학기에도 이 방식 유지해주세요." },
  ];
