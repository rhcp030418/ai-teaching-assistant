...
INSERT INTO "new_Feedback" ("assignment", "comment", "commentCategory", "commentFilterReason", "commentHasProfanity", "communication", "comprehension", "courseId", "createdAt", "filteredComment", "id", "interest", "practice", "roundId", "speed") SELECT "assignment", "comment", "commentCategory", "commentFilterReason", "commentHasProfanity", "communication", "comprehension", "courseId", "createdAt", "filteredComment", "id", "interest", "practice", "roundId", "speed" FROM "Feedback";
DROP TABLE "Feedback";
