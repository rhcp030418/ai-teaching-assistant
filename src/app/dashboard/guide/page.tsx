...
function buildGuideItems(courseBase: string | null) {
  ...
  return {
    required: [
      ...
      {
        title: "강의평가 회차 만들기",
        body: "관리 및 기록에서 주차별 강의평가 회차를 만들고 시작·종료 시간을 지정합니다. 진행 중인 회차가 있어야 e-class로 연동된 수강생이 그 주차 평가를 제출하고, 응답이 해당 주차 통계로 모입니다.",
        href: managementHref,
      },
      {
        title: "현황 요약 확인",
    ...
    optional: [
      {
        title: "추가 피드백 링크 배포",
        body: "정규 주차 평가 외에 강의 전반에 대한 보충 의견이 필요할 때, 관리 및 기록에서 추가 피드백 링크(1회용 익명 링크)를 만들어 e-class나 공지에 공유합니다. 이 링크로 들어온 의견은 특정 주차가 아닌 강의 전반 피드백으로 저장되어 추가 피드백 리포트에 모이며, 주차별 평가 통계에는 포함되지 않습니다.",
        href: managementHref,
      },
      {
        title: "지원 인사이트",
      ...
      {
        title: "강의자료 분석",
        body: "PDF나 TXT 자료를 업로드하면 자료 난이도, 전문 용어 밀도, 예시 충분도와 학생 반응의 연결 맥락을 볼 수 있습니다. PPT는 텍스트 추출이 지원되지 않으니 PDF로 변환해 올려 주세요.",
        href: materialsHref,
      },
      {
        title: "비교 참고",
      ...
      {
        title: "말투 교정",
        body: "학생에게 보낼 공지나 이메일에서 권위적·강압적으로 읽힐 수 있는 표현을 점검하고 더 부드러운 대안을 참고할 때 사용합니다. 학생에게 전달하기 전 최종 표현은 교수자가 직접 확인하는 것이 좋습니다.",
        href: "/dashboard/tone",
      },
    ],
    caution: [
      ...
      {
        title: "강의자료 분석",
        body: "자료 텍스트 추출 품질이나 파일 형식에 따라 분석이 누락되거나 부정확할 수 있습니다. 스캔 이미지 PDF는 자동 OCR로 텍스트를 추출하지만 인식 품질이 낮을 수 있으니, 가능하면 텍스트가 살아 있는 PDF로 업로드하는 편이 좋습니다.",
        href: materialsHref,
      },
    ],
  };
