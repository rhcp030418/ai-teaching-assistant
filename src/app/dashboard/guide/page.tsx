...
function buildGuideItems(courseBase: string | null) {
  ...
  return {
    required: [
      ...
      {
        title: "평가 라운드 열기",
        body: "관리 및 기록에서 주차별 평가 라운드를 만들고 시작·종료 시간을 지정합니다. 진행 중인 라운드가 있어야 e-class로 연동된 수강생이 그 주차 평가를 제출하고, 응답이 해당 주차 통계로 모입니다.",
        href: managementHref,
      },
      {
        title: "현황 요약 확인",
    ...
    optional: [
      {
        title: "추가 피드백 링크 배포",
        body: "정규 주차 평가 외에 강의 전반에 대한 보충 의견이 필요할 때, 관리 및 기록에서 추가 피드백 링크(1회용 익명 링크)를 만들어 e-class나 공지에 공유합니다. 이 링크로 들어온 의견은 특정 주차가 아닌 강의 전반 피드백으로 저장되어 추가 피드백 리포트에 모이며, 주차 라운드 통계에는 포함되지 않습니다.",
        href: managementHref,
      },
      {
        title: "지원 인사이트",
