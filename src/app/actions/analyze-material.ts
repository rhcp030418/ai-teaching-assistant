...
improvements의 structure·examples·pedagogy 제안은 위 도구상자에서 자료의 문제에 맞는 기법을 골라 구체적 실천 행동으로 작성하고, 기법 이름을 괄호로 표기하세요. 또한 그 기법의 [근거]에 적힌 연구·학자를 "~~에 따르면" 형태로 인용해, 그 제안이 효과적인 근거를 한 구절로 밝히세요. 막연한 조언("예시를 늘리세요")이나 도구상자에 없는 연구를 지어내는 것은 금지합니다.`;
