...
export const DEMO_MATERIAL_ANALYSIS: MaterialAnalysis = {
  ...
  improvements: {
    structure:
      "ACID 속성을 한 번에 설명하기보다 속성별 짧은 사례를 먼저 제시한 뒤 정의를 연결하세요 (사전 안내자/advance organizer).",
    examples:
      "인덱스 적용 전후 쿼리 실행 계획을 비교하는 예시를 1개 추가하면 학생이 효용을 더 쉽게 이해할 수 있습니다 (워크드 예제/worked example).",
    pedagogy:
      "핵심 개념 설명 후 1문장 확인 질문을 넣어 학생이 직접 설명하게 하는 활동을 넣어보세요 (인출 연습/retrieval practice).",
  },
};
